...
def plot_phase_diff(export: bool = False) -> None:
    ...
    # * Second subplot, waves out of phase by π/2 radians
    ...
    # * Third subplot with waves in anti-phase (out of phase by π radians)
    ...
    # * Fourth subplot with waves out of phase by -π/2 radians
